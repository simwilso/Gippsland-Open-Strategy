        ...
        <section className={styles.whatsappSection}>
          <div className="container">
            <div className="text--center">
              <h2>Join Our Community Discussion</h2>
              <p>Connect with others passionate about Gippsland's energy future</p>
              <a
                href="https://chat.whatsapp.com/IQvMaudiTwNKjD8z9Su5PI"
                target="_blank"
